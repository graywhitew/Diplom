...
class MyMainFrame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.button = customtkinter.CTkButton(self, text="Модифицированная модель хищник-жертва", command=self.open_toplevel_Lab1, width=50, height=50, font=("Times", 20))
        self.button.grid(row=1, column=0, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="Проточное и непроточное\n моделирование микроорганизмов", command=self.open_toplevel_Lab2, width=50, height=50, font=("Times", 20))
...
class Lab1_Formula_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)
        self.title = customtkinter.CTkLabel(self, text="", fg_color="azure", corner_radius=6, font=("Times", 14))
...
class Lab1_Param_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.title = customtkinter.CTkLabel(self, text="Количество растительности:", fg_color="azure", corner_radius=6, font=("Times", 14))
        ...
        self.title = customtkinter.CTkLabel(self, text="Коэф. антропогенного фактора:", fg_color="azure", corner_radius=6, font=("Times", 14))
        ...
        self.title = customtkinter.CTkLabel(self, text="Коэф. биотического фактора:", fg_color="azure", corner_radius=6, font=("Times", 14))
...
class Lab1_Button_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        ...
        self.button = customtkinter.CTkButton(self, text="Графики популяций", command=master.Lab1_plot, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=0, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="Фазовый портрет", command=master.Lab1_PhasePortrait, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=1, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="Методичка", command=master.Lab1_plot, width=50, height=50, font=("Times", 14))
...
class Lab2_Formula_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)
        self.title = customtkinter.CTkLabel(self, text="", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=0, column=0, columnspan=2, padx=10, pady=(10, 10), sticky="ew")

class Lab2_WrittenBy_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)

class Lab2_Param_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)

        self.title = customtkinter.CTkLabel(self, text="Максимальная скорость роста:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=0, column=0, padx=10, pady=(10, 0))
        self.spinbox_0 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.9)
        self.spinbox_0.grid(row=0, column=1, padx=(0, 10), pady=(10, 10))

        self.title = customtkinter.CTkLabel(self, text="Значение коэф. Ks:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=1, column=0, padx=10, pady=(10, 0))
        self.spinbox_1 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.25)
        self.spinbox_1.grid(row=1, column=1, padx=(0, 10), pady=(10, 10))
        self.title = customtkinter.CTkLabel(self, text="Значение экономического коэф.:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=1, column=2, padx=10, pady=(10, 0))
        self.spinbox_2 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.2)
        self.spinbox_2.grid(row=1, column=3, padx=(0, 10), pady=(10, 10))

        self.title = customtkinter.CTkLabel(self, text="Значение скорости потока(разбавления):", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=2, column=0, padx=10, pady=(10, 0))
        self.spinbox_3 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.75)
        self.spinbox_3.grid(row=2, column=1, padx=(0, 10), pady=(10, 10))
        self.title = customtkinter.CTkLabel(self, text="Значение конц. субстрата\nпоступающего в культиватор:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=2, column=2, padx=10, pady=(10, 0))
        self.spinbox_4 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.2)
        self.spinbox_4.grid(row=2, column=3, padx=(0, 10), pady=(10, 10))

        self.title = customtkinter.CTkLabel(self, text="Начальные значения\nX-концентрацию биомассы микроорганизмов\nµ-удельная скорость роста биомассы\nS-субстрат:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=3, column=0, padx=10, pady=(10, 0))
        self.spinbox_5 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.2)
        self.spinbox_5.grid(row=3, column=1, padx=(0, 10), pady=(10, 10))
        self.spinbox_6 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.2)
        ...
        self.title = customtkinter.CTkLabel(self, text="Значение коэф. g:", fg_color="azure", corner_radius=6, font=("Times", 14))
        self.title.grid(row=4, column=0, padx=10, pady=(10, 0))
        self.spinbox_8 = FloatSpinbox(self, width=150, step_size=0.05, def_value = 0.2)
        self.spinbox_8.grid(row=4, column=1, padx=(0, 10), pady=(10, 10))
               
class Lab2_Button_Frame(customtkinter.CTkFrame):
    def __init__(self, master):
        super().__init__(master)
        self.grid_columnconfigure((0,1,2,3), weight=1)
        self.button = customtkinter.CTkButton(self, text="Графики популяций", command=master.Lab2_plot, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=0, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="Фазовый портрет", command=master.Lab2_PhasePortrait, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=1, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="Методичка", command=master.Lab2_plot, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=2, padx=10, pady=10, sticky="ew")
        self.button = customtkinter.CTkButton(self, text="В отдельном окне", command=master.Lab2_NewWindow, width=50, height=50, font=("Times", 14))
        self.button.grid(row=0, column=3, padx=10, pady=10, sticky="ew")
